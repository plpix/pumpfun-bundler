...
export class PumpFunSDK {
  ...
  public GLOBAL_MINT = new PublicKey(
    "p89evAyzjd9fphjJx7G3RFA48sbZdpGEppRcfRNpump"
  );
  public PROGRAM_ID = new PublicKey(
    "6EF8rrecthR5Dkzon8Nwu78hRvfCKubJ14M5uBEwF6P"
  );
  public MPL_TOKEN_METADATA_PROGRAM_ID = new PublicKey(
    ...
    for (const [i, array] of splitedKeypairArray.entries()) {
      ...
      for (const [j, keypairItem] of array.entries()) {
        ...
        try {
          ...
          if (
            this.associatedUsers.includes(associatedUser.toBase58()) == false
          ) {
